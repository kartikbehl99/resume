...
\begin{topic}{Skills}
    ...
    \skillset{Languages}{Python, C++, JavaScript, Ruby}
    \skillset{Frameworks}{Flask, Angular, Ruby on Rails}
    \skillset{Database}{PostgreSQL, MySQL, DynamoDB, MongoDB}
    \skillset{Tools and Technologies}{Git, AWS, Selenium, Ansible, HTML, CSS}
    \skillset{Other skills}{Data Structures, Algorithms, OO Design, SQL, System Design, Cloud Computing}
...
\begin{topic}{Experience}
    ...
    \entry{Software Engineer - Internship}{2020 - Present}
    {Coding Ninjas}
    {\begin{tightitemize}
    ...
    \end{tightitemize}}
    \entry{Software Engineer - Internship}{2019 - 2020}
    {OpsLyft}
    {\begin{tightitemize}

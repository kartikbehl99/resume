...
\begin{center}
    ...
    \small \href{tel:9990290880}{+91-9990290880} $|$ \href{mailto:kartikbehl99@gmail.com}{\underline{kartikbehl99@gmail.com}} $|$ 
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Built features like RI rightsizing, Idle resources monitoring, AWS Well-architected framework suggestions into the product.}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{The replication process is entirely automated.}
          \resumeItemListEnd
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{It also gives real-time insights about usage statistics such as CPU Utilization, Memory Utilization, Volume used etc which helps in granular level management of resources and saves thousands of dollars.}
         \resumeItemListEnd
    \resumeSubHeadingListEnd
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Tools and Technologies}{: Git, AWS, Selenium, Ansible} \\
